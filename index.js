...
@media (min-width:1200px) {
    .main{
        ...
        <h1 class="word">${words[count].word} <span class="word-classify">${words[count].type}</span></h1>
        ...
        <div class="pronounce_cont" onclick="pronounce()">
                        ...
                        <p class="pronounce">Pronounciation: <span class="word-pronounce" id="pronounce_word">${words[count].pronounciation}</span></p>
                    </div>
